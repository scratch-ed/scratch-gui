...
declare class Cloud {
     ...
     */
    postData(data: CloudIOData): void;
     ...
     */
    updateCloudVariable(varUpdate: any): void;
    /**
...
declare namespace Cloud {
    export { updateVariable, CloudProvider, VarUpdateData, CloudIOData };
}
/**
 * A cloud data provider, responsible for managing the connection to the
 * cloud data server and for posting data about cloud data activity to
