...
declare class Runtime extends EventEmitter {
     ...
     */
    getBlocksXML(target?: any): Array<object>;
    /**
     ...
     */
    getScratchLinkSocket(type: string): any;
    /**
     ...
     */
    _defaultScratchLinkSocketFactory(type: string): any;
    /**
     ...
     */
    addMonitorScript(topBlockId: string, optTarget: any): void;
    /**
     ...
     */
    allScriptsDo(f: Function, optTarget?: any): void;
     ...
     */
    moveExecutable(executableTarget: any, delta: number): number;
    /**
     ...
     */
    setExecutablePosition(executableTarget: any, newIndex: number): number;
    /**
     * Remove a target from the execution set.
     * @param {Target} executableTarget target to remove
     */
    removeExecutable(executableTarget: any): void;
    /**
     * Dispose of a target.
     * @param {!Target} disposingTarget Target to dispose of.
     */
    disposeTarget(disposingTarget: any): void;
    /**
     * Stop any threads acting on the target.
     * @param {!Target} target Target to stop threads for.
     * @param {Thread=} optThreadException Optional thread to skip.
     */
    stopForTarget(target: any, optThreadException?: Thread | undefined): void;
    /**
     ...
     */
    setEditingTarget(editingTarget: any): void;
    /**
     ...
     */
    getTargetById(targetId: string): any;
    /**
     * Get the first original (non-clone-block-created) sprite given a name.
     * @param {string} spriteName Name of sprite to look for.
     * @return {?Target} Target representing a sprite of the given name.
     */
    getSpriteTargetByName(spriteName: string): any;
    /**
     * Get a target by its drawable id.
     * @param {number} drawableID drawable id of target to find
     * @return {?Target} The target, if found
     */
    getTargetByDrawableId(drawableID: number): any;
    /**
    ...
    /**
     * Turn on profiling.
     * @param {FrameCallback} onFrame A callback handle passed a
     * profiling frame when the profiler reports its collected data.
     */
    enableProfiling(onFrame?: Profiler.FrameCallback): void;
    /**
     * Turn off profiling.
     */
